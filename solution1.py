...
class BO_algo():
    def __init__(self):
        ...
        '''
        Empty arrays initialized to store observed data points related 
        to the structural features (x), logP (f), synthesizability (v), 
        and the gradient of the synthesizability.
        '''
    ...
    def acquisition_function(self, x):
        ...
        if sigma != 0:
            ...
            if mu <= self.v_max:
                ...
                pr = 0.02 * (mu-self.v_max)   # 0.98, 0.02; 0.5 0.5

        return float(expected_improvement * 0.5 * pr)
